<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="beautyFinal.aspx.cs" Inherits="beautyFinal" %>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Search for Beauty's Remedy</h4>
                                        ...
                                        <div class="form-group">
                                            <asp:GridView ID="GridView2" runat="server" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="BeautyImage">
                                                        <ItemTemplate>
                                                            <asp:Image ID="Image1" runat="server" ImageUrl='<%#"data:Image/png;base64,"+ Convert.ToBase64String((byte[])Eval("BeautyImage"))%>' Height="200px" Width="333px" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="BeautyMaster.aspx.cs" Inherits="BeautyMaster" %>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Beauty Name</label>
                                            <asp:TextBox ID="txtBeauty" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            <h3 class="box-title">Beauty Details</h3>
                                        </div>
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <asp:GridView ID="gvBtyDetails" runat="server" Width="100%"
                                                    ...
                                                    PagerStyle-HorizontalAlign="Right" OnPageIndexChanging="gvBtyDetails_PageIndexChanging"
                                                    OnRowCommand="gvBtyDetails_RowCommand"
                                                    OnRowDeleting="gvBtyDetails_RowDeleting"
                                                    OnRowEditing="gvBtyDetails_RowEditing"
                                                    OnRowUpdating="gvBtyDetails_RowUpdating">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Bank Name">
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtBankName" Width="80%" runat="server" Text='<%#Eval("BeautyName") %>' />
                                                            </EditItemTemplate>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBankName" Width="80%" runat="server" Text='<%#Eval("BeautyName") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

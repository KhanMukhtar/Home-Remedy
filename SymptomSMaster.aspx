<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="SymptomSMaster.aspx.cs" Inherits="SymptomSMaster" %>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            <h3 class="box-title">Symptoms Details</h3>
                                        </div>
                                        <!-- /.box-header -->
                                        <div class="box-body">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <asp:GridView ID="gvsysDetails" runat="server" Width="100%"
                                                    ...
                                                    PagerStyle-HorizontalAlign="Right" OnPageIndexChanging="gvsysDetails_PageIndexChanging"
                                                    OnRowCommand="gvsysDetails_RowCommand"
                                                    OnRowDeleting="gvsysDetails_RowDeleting"
                                                    OnRowEditing="gvsysDetails_RowEditing"
                                                    OnRowUpdating="gvsysDetails_RowUpdating">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Bank Name">
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtBankName" Width="80%" runat="server" Text='<%#Eval("SymptomsName") %>' />
                                                            </EditItemTemplate>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBankName" Width="80%" runat="server" Text='<%#Eval("SymptomsName") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
